  ...
  static generateRequestsByRole(count: number, role: 'Admin' | 'Member'): TaxiRequest[] {
    return Array.from({ length: count }, (_, i) => {
      ...
      const items = [
        {
          date: dateStr,
          description: 'เดินทางไปพบลูกค้ากนกวัฒนา',
          destination: 'GMM Grammy',
          distance: 12.5,
          amount: 250,
          shiftCode: 'O01 09.00-18.00',
          attachedFile: 'receipt_01.jpg',
        },
        {
          date: dateStr,
          description: 'เดินทางกลับสำนักงานจากพบลูกค้า',
          destination: 'Office',
          distance: 12.5,
          amount: 230,
          shiftCode: 'O01 09.00-18.00',
          attachedFile: 'receipt_02.jpg',
        },
      ];
