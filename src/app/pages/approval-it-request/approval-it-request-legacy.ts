...
@Component({
  selector: 'app-approval-it-request-legacy',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class ApprovalItRequestLegacyComponent implements OnInit {
  ...
  readonly showDateRangeFilter = false;
  ...
  readonly canFilterApprovalStage = () => false;
  readonly canSeeWaitingApprover = () => false;
  ...
  setApprovalStageFilter(stage: 'all' | 'approver' | 'director') {
