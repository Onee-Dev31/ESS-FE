...
export const PAGE_META: Record<string, PageMeta> = {
  dashboard: {
    ...
    apis: [
      {
        method: 'GET',
        endpoint: '/employee-service-info/:empCode',
        description: 'ข้อมูลสิทธิ์พนักงาน',
      },
    ...
    notes:
      'SP: sp_GetLeaveSummaryDashboard, sp_GetTransportClaims, sp_GetMyTaxiClaims — ดู table เพิ่มเติมจาก SP definition ใน DB',
  },
  ...
  'it-dashboard': {
    ...
    apis: [
      ...
      {
        method: 'GET',
        endpoint: '/Master/assign-dropdown',
        description: 'รายชื่อ IT สำหรับ assign',
      },
  ...
  vehicle: {
    ...
    notes:
      'SP: sp_GetTransportClaims, sp_CreateTransportClaim, sp_UpdateTransportClaim, sp_DeleteTransportClaim, sp_GetEligibleTransportDates_v2',
  },
  ...
  'vehicle-taxi': {
    ...
    notes:
      'SP: sp_GetMyTaxiClaims, sp_CreateTaxiClaim, sp_UpdateTaxiClaim, sp_DeleteTaxiClaim, sp_GetTaxiLocations, sp_GetEligibleTaxiDates',
  },
  ...
  allowance: {
    ...
    apis: [
      ...
      {
        method: 'GET',
        endpoint: '/meal-allowance/eligible-dates',
        description: 'วันที่สามารถเบิกได้',
      },
  ...
  'approvals-allowance': {
    ...
    apis: [
      ...
      {
        method: 'PATCH',
        endpoint: '/meal-allowance/claims/:id/review',
        description: 'อนุมัติ/ปฏิเสธ',
      },
    ],
  },
  ...
  'approvals-velhicle': {
    ...
    apis: [
      ...
      {
        method: 'PATCH',
        endpoint: '/transport-claim/claims/:id/review',
        description: 'อนุมัติ/ปฏิเสธ',
      },
    ],
  ...
  timeoff: {
    title: 'วันลา',
    tables: [],
    apis: [{ method: 'GET', endpoint: '/leave/requests', description: 'รายการคำขอลา' }],
  ...
  'it-problem-report': {
    ...
    apis: [
      {
        method: 'GET',
        endpoint: '/Master/open-for',
        description: 'รายชื่อที่สามารถเปิด ticket แทนได้',
      },
  ...
  'it-request-signature': {
    title: 'ลายเซ็นงาน IT',
    tables: ['tickets', 'ticket_assignments'],
    apis: [
  ...
  'freelance-management': {
    ...
    notes:
      'SP: usp_GetFreelanceList, usp_GetFreelanceListAll, usp_GetFreelanceById_Dynamic, usp_FreelanceOperation_V2 — ดู table จาก SP definition ใน DB',
  },

  'resign-management': {
    title: 'จัดการการลาออก',
    tables: ['HRMS.T_EMPLOYEE_SSO'],
    apis: [
      { method: 'GET', endpoint: '/employees', description: 'รายชื่อพนักงาน' },
    ...
    notes:
      'SP: usp_GetEmployeeResigned, usp_InsertEmployeeResigned, usp_InsertEmployeeResigned_Bulk_XML, usp_UpdateEmployeeResigned, usp_DeleteEmployeeResigned — ดู table จาก SP definition ใน DB',
  },
  ...
  'menu-setting': {
    ...
    notes:
      'SP: usp_GetAllMenus, usp_CreateMenu, usp_UpdateMenuData, usp_SaveMenuRolePermissions, sp_UserRole_ManageAll — ดู table เมนูเพิ่มเติมจาก SP definition ใน DB',
  },
    ...
    apis: [
      {
        method: 'GET',
        endpoint: '/dept-heads',
        description: 'รายการหัวหน้าแผนกทั้งหมด (จาก HRMS)',
      },
      ...
      {
        method: 'DELETE',
        endpoint: '/dept-heads/overrides/:costCent',
        description: 'ลบ Override รายแผนกทั้งหมด',
      },
      {
        method: 'DELETE',
        endpoint: '/dept-heads/overrides/:costCent/:level',
        description: 'ลบ Override รายแผนกเฉพาะระดับ',
      },
      {
        method: 'GET',
        endpoint: '/dept-heads/employee-overrides',
        description: 'Override รายบุคคล',
      },
      {
        method: 'PUT',
        endpoint: '/dept-heads/employee-overrides',
        description: 'บันทึก Override รายบุคคล',
      },
      {
        method: 'DELETE',
        endpoint: '/dept-heads/employee-overrides/:empCode',
        description: 'ลบ Override รายบุคคลทั้งหมด',
      },
      {
        method: 'DELETE',
        endpoint: '/dept-heads/employee-overrides/:empCode/:level',
        description: 'ลบ Override รายบุคคลเฉพาะระดับ',
      },
    ],
    notes:
      'SP: sp_GetDeptHeadsWithEmployees, sp_GetDeptHeadOverrides, sp_UpsertDeptHeadOverride, sp_DeleteDeptHeadOverride, sp_GetEmployeeHeadOverrides, sp_UpsertEmployeeHeadOverride, sp_DeleteEmployeeHeadOverride | ลำดับความสำคัญ: employee_head_overrides > dept_head_overrides > HRMS.DEPT_HEAD_HIERARCHY',
  },
};
